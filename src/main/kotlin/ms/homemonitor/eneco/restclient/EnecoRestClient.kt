...
import ms.homemonitor.eneco.restclient.model.EnecoDataModel
import ms.homemonitor.eneco.restclient.model.EnecoUsageEntry
...
@Service
class EnecoRestClient(
    private val enecoAccessToken: EnecoAccessToken) {

    private val restTemplate = RestTemplate()
    private val log = LoggerFactory.getLogger(EnecoRestClient::class.java)
