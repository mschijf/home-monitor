...
from power inner join power as prevpower
                          on date_sub(power.time, interval '0 1:0:0' day_second) = prevpower.time
where minute(power.time) = 0 and second(power.time) = 0;
